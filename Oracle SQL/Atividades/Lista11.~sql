...
-- 2 Tabelas
DROP VIEW getCountries;
CREATE VIEW getCountries AS
SELECT 
	countries.country_name AS País,
	regions.region_name AS Região
FROM countries
INNER JOIN regions ON (regions.region_id = countries.region_id);

SELECT * FROM getCountries;

DROP VIEW getCustomersInfo;
CREATE VIEW getCustomersInfo AS
SELECT
	customers.name AS Nome,
	customers.address AS Endereço,
	contacts.email AS Email,
	contacts.phone AS Telecone
FROM customers
INNER JOIN contacts ON contacts.customer_id = customers.customer_id;

SELECT * FROM getCustomersInfo;
	
-- 3 tabelas
DROP VIEW getWareHouses;
CREATE VIEW getWareHouses AS
	SELECT 
    ...
    FROM warehouses
    INNER JOIN locations ON (locations.location_id = warehouses.location_id)
    INNER JOIN countries ON (countries.country_id = locations.country_id);
    
SELECT * FROM getWareHouses;

DROP VIEW getProdutcs;
CREATE VIEW getProducts AS
SELECT 
	products.product_name AS Produto,
	products.description AS Descrição,
	product_categories.category_name AS Categoria,
	inventories.quantity AS Quantidade
FROM products
INNER JOIN product_categories ON product_categories.category_id = products.category_id
INNER JOIN inventories ON inventories.product_id = products.product_id;

SELECT * FROM getProducts;

DROP VIEW getLowStockProducts ;
CREATE VIEW getLowStockProducts AS 
SELECT 
	products.product_name AS Produto,
	products.description AS Descrição,
	product_categories.category_name AS Categoria,
...
INNER JOIN product_categories ON product_categories.category_id = products.category_id
INNER JOIN inventories ON inventories.product_id = products.product_id
WHERE inventories.quantity < 150;

SELECT * FROM getLowStockProducts;


-- 5 tabelas
DROP VIEW getDetailedProducts;
CREATE VIEW getDetailedProducts AS
SELECT 
	products.product_name AS Produto,
	products.description AS Descrição,
	product_categories.category_name AS Categoria,
	inventories.quantity AS Quantidade,
    warehouses.warehouse_name AS Loja,
    locations.address AS Endereço,
    locations.postal_code AS Codigo_Postal,
    countries.country_name AS País
FROM products
INNER JOIN product_categories ON product_categories.category_id = products.category_id
INNER JOIN inventories ON inventories.product_id = products.product_id
...
SELECT * FROM getDetailedProducts;


DROP VIEW getLowQualityProducts;
CREATE VIEW getLowQualityProducts AS
SELECT 
	products.product_name AS Produto,
	products.description AS Descrição,
    products.standard_cost AS Preço,
	product_categories.category_name AS Categoria,
	inventories.quantity AS Quantidade,
    warehouses.warehouse_name AS Loja,
    locations.address AS Endereço,
...
INNER JOIN locations ON locations.location_id = warehouses.location_id
INNER JOIN countries ON countries.country_id = locations.country_id
WHERE countries.country_name = 'China' AND products.standard_cost < 100;

SELECT * FROM getLowQualityProducts;


-- 7 Tabelas
DROP VIEW evenMoreDetailedProducts;
CREATE VIEW evenMoreDetailedProducts AS
SELECT 
	products.product_name AS Produto,
	products.description AS Descrição,
	product_categories.category_name AS Categoria,
    ...
    locations.postal_code AS Codigo_Postal,
    countries.country_name AS País,
	regions.region_name AS Continente
FROM products
INNER JOIN product_categories ON product_categories.category_id = products.category_id
INNER JOIN inventories ON inventories.product_id = products.product_id
INNER JOIN warehouses ON inventories.warehouse_id = warehouses.warehouse_id
...
SELECT * FROM evenMoreDetailedProducts;

DROP VIEW customersOrders;
CREATE VIEW customersOrders AS
SELECT
	customers.name AS Clientes,
	contacts.phone AS Telefone_cliente,
	products.product_name AS Produto,
	product_categories.category_name AS Categoria,
	orders.order_date AS Data_da_compra,
	order_items.quantity AS Quantidade_comprada,
	order_items.unit_price AS Preço_unitário,
	employees.first_name AS Vendedor
FROM customers
INNER JOIN contacts ON contacts.customer_id = customers.customer_id
...
DROP VIEW customersOrderAndProductDetails;
CREATE VIEW customersOrderAndProductDetails AS
SELECT 
	customers.name AS Clientes,
	contacts.phone AS Telefone_cliente,
	products.product_name AS Produto,
